...
foreach (var table in new[] { "GameTags", "TagRevisions", "GameDisciplines", "DisciplineRevisions" })
...
foreach (var type in new[] { typeof(CategoriesController), typeof(ClassesController), typeof(TagsController) })
{
